...
namespace rude 
{
	namespace config 
	{
		...
		public:
			...
			// DATA CONVERSION
			//
			static bool stringToBool(const char* string, bool defaultValue);
			static const char* boolToString(bool value);
			static int stringToInt(const char* string, int defaultValue);
			static const char* intToString(int value);
			static double stringToDouble(const char* string, double defaultValue);
			...
			const char* getStringValue(const char* name, const char* defaultValue = 0) const;
