...
namespace rude 
{
    namespace config 
    {
        ...
        char* Base64Encoder::encode(const char* data, int datalength, int& outlength)
        {
            ...
            if (data == (char*)0 || datalength == 0) return (char*)0;
            ...
            for (int i = 0; i < datalength; i += 3)
            {
                ...
                if (i + 1 < datalength) by2 = data[i + 1];
                else by2 = 0;

                if (i + 2 < datalength) by3 = data[i + 2];
                else by3 = 0;
                ...
                {
                    for (int y = 0; y < crlflength; y++) retval[outlength++] = crlf[y];
        ...
        char* Base64Encoder::decode(const char* data, int datalength, int& outlength)
        {
            ...
            {
                if (IsBase64(data[j])) outbuffer[rawlength++] = data[j];
            }
            ...
            for (int i = 0; i < rawlength; i += 4)
            {
                ...
                if (i + 1 < rawlength) c2 = outbuffer[i + 1];

                if (i + 2 < rawlength) c3 = outbuffer[i + 2];

                if (i + 3 < rawlength) c4 = outbuffer[i + 3];
